...
VALUES (1, NOW(), 'Cheeseburger', 599, 'Juicy beef patty with melted cheese on a sesame seed bun');

INSERT INTO Product (STATS, DATA_CREATE, NAME, PRICE, DESCRIPTION) 
VALUES (1, NOW(), 'Coffee', 299, 'Freshly brewed coffee');

INSERT INTO Product (STATS, DATA_CREATE, NAME, PRICE, DESCRIPTION) 
VALUES (1, NOW(), 'Margherita Pizza', 899, 'Classic pizza topped with tomato, mozzarella, and basil');

INSERT INTO Product (STATS, DATA_CREATE, NAME, PRICE, DESCRIPTION) 
VALUES (1, NOW(), 'Taco', 499, 'Traditional Mexican taco with your choice of filling');
